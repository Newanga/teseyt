      ...
      <Popover
        ...
        className={({ open }) =>
          classNames(
            ...
            "bg-sky-500 shadow-sm lg:static lg:overflow-y-visible"
          )
        }
      >
        {({ open }) => (
          <>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
                ...
                <a
                    href="#"
                    className="bg-white text-gray-400 ml-6 inline-flex items-center rounded-md border border-transparent  px-4 py-2 text-sm font-medium  shadow-sm  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  >
                    Login
                  </a>
                  <a
